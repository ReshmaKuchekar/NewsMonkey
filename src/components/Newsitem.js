      ...
      <div className='my-3'>
        <div className="card" style={{height: '30rem', boxShadow: '0px 0px 15 px 1px #161111',borderRadius: '22px'}}>
            ...
            <div className="card-body">
                ...
                <div className="mybtn">
                  <a rel=" noopener noreferrer" href={newsUrl}  target="_blank" className="btn btn-sm btn-dark" style={{backgroundColor:'#faa178', fontWeight:'600', color:'black', border:'0px', padding:'10px 20px'}}>Read More</a>
                </div>
            </div>
        </div>
      </div>
